// -----------------------------------------------------------------------
// <copyright file="EnglishPluralizer.cs" company="Ollon, LLC">
...
namespace Microsoft.EntityFrameworkCore.Design.Impl
{
    ...
    public class Pluralizer : IPluralizer
    {
        ...
        private readonly IReadOnlyDictionary<string, string> _oSuffixReverseList;
        private readonly IReadOnlyDictionary<string, string> _classicalInflectionReverseList;
        private readonly IEnumerable<string> _knownSingularWords;
        private readonly IEnumerable<string> _knownPluralWords;
        private readonly CultureInfo _culture = new CultureInfo("en-US");
        private readonly IEnumerable<string> _uninflectiveSuffixes = new[] { "fish", "ois", "sheep", "deer", "pos", "itis", "ism" };
        private readonly IEnumerable<string> _uninflectiveWords = new HashSet<string>
        {
        ...
        private readonly IReadOnlyDictionary<string, string> _irregularVerbReverseList = new Dictionary<string, string>
        {
            {"are", "am"},
            {"were", "was"},
            {"have", "has"}
        };
        private readonly IEnumerable<string> _pronounList = new HashSet<string>
        {
        ...
        private readonly IReadOnlyDictionary<string, string> _irregularPluralsList = new Dictionary<string, string>
        {
            {"brother", "brothers"},
            {"child", "children"},
            {"cow", "cows"},
        ...
        private readonly IReadOnlyDictionary<string, string> _assimilatedClassicalInflectionList = new Dictionary<string, string>
        {
            {"alumna", "alumnae"},
            {"alga", "algae"},
            {"vertebra", "vertebrae"},
        ...
        private readonly IReadOnlyDictionary<string, string> _oSuffixList = new Dictionary<string, string>
        {
            {"albino", "albinos"},
        ...
        private readonly IReadOnlyDictionary<string, string> _classicalInflectionList = new Dictionary<string, string>
        {
            {"stamen", "stamina"},
            {"foramen", "foramina"},
            {"lumen", "lumina"},
        ...
        private readonly IEnumerable<string> _knownConflictingPluralList = new HashSet<string>
        {
        ...
        // singularize to "s"
        private readonly IReadOnlyDictionary<string, string> _wordsEndingWithSeReverseList = new Dictionary<string, string>
        {
            {"houses", "house"},
            {"cases", "case"},
        ...
        private readonly IReadOnlyDictionary<string, string> _wordsEndingWithSisReverseList = new Dictionary<string, string>
        {
            {"analyses", "analysis"},
            {"crises", "crisis"},
            {"bases", "basis"},
        ...
        /// <param name="identifier" >The word to be made plural.</param>
        public string Pluralize(string identifier)
            => Capitalize(identifier, InternalPluralize);

        /// <summary>Returns the singular form of the specified word.</summary>
        /// <returns>The singular form of the input parameter.</returns>
        /// <param name="identifier" >The word to be made singular.</param>
        public string Singularize(string identifier)
            => Capitalize(identifier, InternalSingularize);
        ...
        private bool IsPlural(string word)
            => IsUninflective(word) || _knownPluralWords.Contains(word.ToLower(_culture)) ? true : !Singularize(word).Equals(word);
        ...
        private static string Capitalize(string word, Func<string, string> action)
        {
            ...
            return IsCapitalized(word) && result.Length != 0 ? char.ToUpperInvariant(result[0]) + result.Substring(1) : result;
        }
        ...
        private bool DoesWordContainSuffix(string word, IEnumerable<string> suffixes)
            => suffixes.Any(s => word.EndsWith(s, true, _culture));

        private bool TryInflectOnSuffixInWord(
            string word,
        ...
        private static Dictionary<string, string> Reverse(IEnumerable<KeyValuePair<string, string>> dictionary)
        {
